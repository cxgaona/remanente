...
@Named(value = "egresosCtrl1")
@ViewScoped
public class EgresosCtrl1 extends BaseCtrl implements Serializable {
    ...
    public void addRowFacturaPagada() {
        ...
        try {
            ...
            Logger.getLogger(EgresosCtrl1.class.getName()).log(Level.SEVERE, null, ex);
        }
