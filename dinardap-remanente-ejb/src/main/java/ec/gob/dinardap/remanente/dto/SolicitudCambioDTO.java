...
public class SolicitudCambioDTO {
    ...
    public SolicitudCambioDTO(RemanenteMensual remanenteMensual) {
        ...
        this.institucionNombre = remanenteMensual.getRemanenteCuatrimestral().getRemanenteAnual().getInstitucion().getNombre();
    ...
    public SolicitudCambioDTO(Institucion institucion, String institucionNombre, RemanenteMensual remanenteMensual, Integer mesInt, Integer año) {
